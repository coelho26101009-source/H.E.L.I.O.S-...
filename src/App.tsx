    ...
    <div className="flex-1 flex flex-col items-center justify-center gap-8 px-6 pb-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl md:text-3xl font-semibold text-[#ececec] mb-2 tracking-tight">
          Olá, sou o{' '}
          <span className="text-amber-500 font-bold">H.E.L.I.O.S.</span>
        </h2>
...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    addLog('SYSTEM', 'A iniciar H.E.L.I.O.S...');
    const t = setTimeout(() => {
  ...
  const handleMicToggle = useCallback(() => {
    toggleMic((transcript) => {
      // O transcript volta via callback — passa direto para o input
      // Como o InputBar controla o state do texto, usamos um evento custom
      const evt = new CustomEvent('helios-transcript', { detail: transcript });
        ...
        <header className="h-14 flex items-center justify-between px-4 border-b border-white/5 bg-[#13131f]/80 backdrop-blur-sm flex-shrink-0">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[#1a1a28] border border-amber-500/14 text-xs text-white/45 cursor-default select-none">
              ...
              <span className="font-medium tracking-wide">H.E.L.I.O.S. V4.0</span>
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin scrollbar-thumb-amber-900/15">
              {!hasMessages ? (
                ...
                <div className="max-w-2xl mx-auto px-4 py-6">
                  {/* Show the HeliosCore small above messages */}
                  ...
                  {/* Messages — rendered inside Terminal but we use a simple list here */}
                  <div className="space-y-6">
                        ...
                        <div key={log.id} className={`flex gap-3 ${isUser ? 'flex-row-reverse' : ''}`}>
                          ...
                          <div className={`flex flex-col gap-1 max-w-[80%] ${isUser ? 'items-end' : 'items-start'}`}>
                            <span className="text-[10px] text-white/25 font-mono px-1">
                              {log.timestamp}{!isUser && ' · H.E.L.I.O.S.'}
                            </span>
                    ...
                    {isLoading && (
                      <div className="flex gap-3">
                        <div className="w-8 h-8 rounded-full flex items-center justify-center text-[10px] font-bold shrink-0 bg-gradient-to-br from-amber-500 to-orange-600 border border-amber-500/40 text-white">H</div>
